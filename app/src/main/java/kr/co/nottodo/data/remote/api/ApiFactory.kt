...
object ServicePool {
    ...
    val recommendActionListService = ApiFactory.create<RecommendActionListService>()
    val recommendMissionListService = ApiFactory.create<RecommendMissionListService>()
